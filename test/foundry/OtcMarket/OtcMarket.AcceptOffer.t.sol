...
contract AcceptOffer is OtcMarketTestHelper {
    ...
    // function testFuzz_UpdateBalancesAcceptOffer(
    //     uint256 srcAmountLD,
    ...
    //     address srcBuyerAddress = makeAddr("srcBuyerAddress");
    ...
    //     uint256 escrowBalance = ERC20(address(aToken)).balanceOf(address(aEscrow));
    //     uint256 srcBuyerBalance = ERC20(address(aToken)).balanceOf(address(srcBuyerAddress));
    //     uint256 dstTreasuryBalance = ERC20(address(bToken)).balanceOf(address(bTreasuryAddress));
